...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 03 sep. 2019 à 19:23
...
CREATE TABLE IF NOT EXISTS `demande_creacompte` (
  `ID` varchar(10) NOT NULL,
  `NOM` varchar(30) NOT NULL,
  `PRENOM` varchar(20) NOT NULL,
  `MAIL` varchar(50) NOT NULL,
...
INSERT INTO `demande_creacompte` (`ID`, `NOM`, `PRENOM`, `MAIL`, `TEL`, `ADRESSE`, `JUSTIFICATIF`) VALUES
('1000', 'nom0', 'prenom_0', 'guest000@gestibank.com', '3391679156', 'adresse', 'None'),
('1001', 'nom1', 'prenom_1', 'guest001@gestibank.com', '2113474599', 'adresse', 'None'),
('1002', 'nom2', 'prenom_2', 'guest002@gestibank.com', '4761751125', 'adresse', 'None'),
('1003', 'nom3', 'prenom_3', 'guest003@gestibank.com', '6737112155', 'adresse', 'None'),
('1004', 'nom4', 'prenom_4', 'guest004@gestibank.com', '1923698368', 'adresse', 'None'),
('1005', 'nom5', 'prenom_5', 'guest005@gestibank.com', '3913586189', 'adresse', 'None'),
('1006', 'nom6', 'prenom_6', 'guest006@gestibank.com', '8834178517', 'adresse', 'None'),
('1007', 'nom7', 'prenom_7', 'guest007@gestibank.com', '5330974348', 'adresse', 'None'),
('1008', 'nom8', 'prenom_8', 'guest008@gestibank.com', '8446748659', 'adresse', 'None'),
('1009', 'nom9', 'prenom_9', 'guest009@gestibank.com', '3180386407', 'adresse', 'None');
